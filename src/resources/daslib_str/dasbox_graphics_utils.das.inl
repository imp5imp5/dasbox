...
"    return res\n"
"\n"
"def delete_image_from_collection(image_handle: ImageHandle)\n"
...
"\n"
"def clone_image_in_collection(image_handle: ImageHandle): ImageHandle\n"
"    var i = allocate_image()\n"
"    images[i] := images[image_handle.index]\n"
"    return setup_image(i)\n"
"\n"
"def create_image_in_collection(file_name: string; smooth: bool = false; use_mips"
": bool = false): ImageHandle\n"
"    var i = allocate_image()\n"
"    images[i] <- create_image(file_name)\n"
"    return setup_image(i, smooth, use_mips)\n"
"\n"
"def create_image_in_collection(width, height: int; smooth: bool = false; use_mip"
"s: bool = false): ImageHandle\n"
"    var i = allocate_image()\n"
"    images[i] <- create_image(width, height)\n"
"    return setup_image(i, smooth, use_mips)\n"
"\n"
"def create_image_in_collection(width, height: int; pixels: array<uint> &; smooth"
": bool = false; use_mips: bool = false): ImageHandle\n"
"    var i = allocate_image()\n"
"    images[i] <- create_image(width, height, pixels)\n"
"    return setup_image(i, smooth, use_mips)\n"
"\n"
"def create_image_in_collection(width, height: int; pixels: string; palette): Ima"
"geHandle\n"
"    var i = allocate_image()\n"
...
"\n"
"def get_pixel(image_handle: ImageHandle; x, y)\n"
"    return images[image_handle.index] |> get_pixel(x, y)\n"
"\n"
"def set_image_data(image_handle: ImageHandle; data)\n"
"    return images[image_handle.index] |> set_image_data(data)\n"
"\n"
"def get_image_data(image_handle: ImageHandle; data)\n"
"    return images[image_handle.index] |> get_image_data(data)\n"
"\n"
