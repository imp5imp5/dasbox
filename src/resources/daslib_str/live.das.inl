...
"    return any\n"
"\n"
"def private set_new_context ( var ptr : smart_ptr<Context>; full_restart:bool = "
"false )\n"
...
"            if pvar != null\n"
"                decsState := *(reinterpret<DecsState ?> pvar)\n"
"    appPtr := ptr\n"
...
"            if pctx_var != null\n"
"                var lContext <- reinterpret<smart_ptr<Context>> addr(this_contex"
"t())\n"
"                var css <- @ <| [[&decsState]] ( state : DecsState? )\n"
"                    unsafe\n"
