...
" prefix,suffix:string; const_parent : bool = false )\n"
...
"ck>; a; prefix, suffix:string; const_parent : bool = false )\n"
"    var ftype <- clone_type(a._type)\n"
"    ftype.flags &= ~ TypeDeclFlags constant\n"
"    ftype.flags &= ~ TypeDeclFlags ref\n"
"    var getter = getter_name(a,const_parent)\n"
...
"            if arg._type != null\n"
"                arg._type.flags |= TypeDeclFlags temporary\n"
...
"s, \"_{a.name}\", a._type.flags.constant)\n"
"                            return [[ExpressionPtr]]\n"
"                else\n"
